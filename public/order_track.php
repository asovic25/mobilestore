<?php
// public/user_order_tracking.php
session_start();
...
<?php if ($order): ?>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <h4 class="text-primary"><?= htmlspecialchars($order['product_name']) ?></h4>
            <p>Quantity: <strong><?= $order['quantity'] ?></strong></p>
            <p>Seller: <?= htmlspecialchars($order['seller_name']) ?></p>
    ...
    <!-- Order Timeline -->
    <h5 class="mb-3 text-primary">Order Tracking Timeline</h5>
